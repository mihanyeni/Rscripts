...
# Syntax author:   Justin Wild, Ph.D.         # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Time to split, read ideas below notes <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
# email:           justin.wild@iea-hamburg.de #
# Affiliation:     IEA Hamburg                #
# Syntax language: R (3.5.1)                  # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Check at the end <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
# Project:         CFA Scaling                # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< But this also has single-group MGCFA <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
# Last update:     05-Sep-2019                # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Check at the end <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<

# Title:   CFA and MGCFA script generator
# Purpose: Create Mplus input & output for scales for various analyses

# Package dependencies: MplusAutomation, openxlsx (data.table)<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Always have these! <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< 

####################################################################################################

# Drop: dirSetup, selectionListScale <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Clean these up when finished <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
run.CFA <- function(nameStudy,dirRoot,dirAnalysisPhase,dirGroup,selectionGroup,dirAnalysis,selectionAnalysis,dirRound,selectionIDVars,selectionGroupCodeVar,selectionStrat,selectionCluster,selectionWeight,selectionGlobalDropCountry,selectionGlobalDropLevel,selectionGlobalDropPop,selectionAdjudicateVar,selectionAdjudicateCode,selectionCountryCodeVar,selectionLevelCodeVar,selectionTargetLevelCode,selectionPopCodeVar,selectionImprove,selectionFS,selectionMplusAuto,selectionSuffix,selectionListScalePI,selectionScale,selectionScaleDropItems,selectionScaleDropSpecifics,selectionScaleDropCountry,selectionScaleDropLevel,selectionScaleDropPop){
  ...
  # 1: Prepare names for directory paths, load datasets and files, & prepare drop selections <<<<<<< See below section # Prepare drop selection, line 38 <<<<<<<<<<<<<<<<<<<<<<
  ...
  load(paste0(dirRoot,"/4Rscripts/SupportFiles/dfScale_",gsub(" ","",selectionGroup),".Rda")) # <<<< Don't come from excel sheet so it doesn't update with the Excel sheet... <
  ## Country dataset named "dfCntry"
  load(paste0(dirRoot,"/4Rscripts/SupportFiles/dfCntry_",gsub(" ","",selectionGroup),".Rda"))
  ...
  if(!is.na(dfCntry$LevelID[1])){ #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< What? This looks ok... <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ## Level identifier
  ...
  writeMplus <- function(title, cases, group, auxil, invar, outpt, sdata, selectionIDVars, selectionGroupCodeVar, selectionCountryCodeVar, selectionLevelCodeVar, selectionPopCodeVar, selectionStrat, selectionCluster, selectionWeight, selectionScale, ccode, cntry, path1, path2, estmt, items, itemU, lcode, modin, phant, catgr, suffx){
    mplusSyntax <-
      c('TITLE:',
        '<tabSpace><cfa.title.>.', #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< For each replacement, add numbering and reference below <<<<<<<<<<<<<<<<<<
        '',
        'DATA: FILE IS', #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Consider moving down "FILE IS" <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        '<tabSpace>"<data.path1>',
        '<tabSpace><data.path2><scale.name><phantom.ds>.dat";',
        '',
        'VARIABLE:',
        '<tabSpace>NAMES ARE <id.variabl><id.group..> <id.country> <id.level..><id.pop....><var.strati><var.clustr><var.weight>',
        '<tabSpace><item.names>;',
        '',
        '<tabSpace>USEVARIABLES ARE <items.used>;', #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Think about statement order: necessary, then optional <<<<<<<<<<<<<<<<<<<<
        '<tabSpace>MISSING ARE <items.used> (-999);',
        '<tabSpace><stmt.catgr>',
        '',
        '<tabSpace><stmt.cases>', #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Optional <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        '<tabSpace><stmt.group>',
        '',
        '<tabSpace><stmt.auxil>',
        '',
        '<tabSpace>STRATIFICATION IS <var.strati>;', #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Necessary <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        '<tabSpace>CLUSTER IS <var.clustr>;',
        '<tabSpace>WEIGHT IS <var.weight>;',
        '',
        'ANALYSIS:',
        '<tabSpace>TYPE IS COMPLEX;',
        '<tabSpace>ESTIMATOR IS <estimator.>;',
        '<tabSpace><stmt.invar>',
        '',
        'MODEL:',
    ...
    mplusSyntax <- gsub("<cfa.title.>", title, mplusSyntax)
    mplusSyntax <- gsub("<stmt.cases>", cases, mplusSyntax)
    mplusSyntax <- gsub("<stmt.group>", group, mplusSyntax)
    mplusSyntax <- gsub("<stmt.auxil>", auxil, mplusSyntax)
    mplusSyntax <- gsub("<stmt.invar>", invar, mplusSyntax)
    mplusSyntax <- gsub("<stmt.outpt>", outpt, mplusSyntax)
    ...
    if(!is.na(selectionIDVars)){ #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< Check these are OK (also, lines 245, 252, 257) <<<<<<<<<<<<<<<<<<<<<<<<<<<
      mplusSyntax <- gsub("<id.variabl>", paste0(selectionIDVars," "), mplusSyntax)
    } else {
      mplusSyntax <- gsub("<id.variabl>", "", mplusSyntax)
    }
    mplusSyntax <- gsub("<id.group..>", selectionGroupCodeVar, mplusSyntax)
    mplusSyntax <- gsub("<id.country>", selectionCountryCodeVar, mplusSyntax)
    if(!is.na(selectionLevelCodeVar)){ #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
      mplusSyntax <- gsub("<id.level..>", paste0(selectionLevelCodeVar," "), mplusSyntax)
      mplusSyntax <- gsub("<id.pop....>", paste0(selectionPopCodeVar," "), mplusSyntax)
    } else {
      mplusSyntax <- gsub("<id.level..>", "", mplusSyntax)
      mplusSyntax <- gsub("<id.pop....>", "", mplusSyntax)
    }
    if(!is.na(selectionStrat)){ #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
      mplusSyntax <- gsub("<var.strati>", paste0(selectionStrat," "), mplusSyntax) #<<<<<<<<<<<<<<<< Got to put space in sometimes, take out others...<<<<<<<<<<<<<<<<<<<<<<<<<
    } else {
      mplusSyntax <- gsub("<var.strati>", "", mplusSyntax)
    }
    if(!is.na(selectionCluster)){ #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
      mplusSyntax <- gsub("<var.clustr>", paste0(selectionCluster," "), mplusSyntax) #<<<<<<<<<<<<<< Got to put space in sometimes, take out others...<<<<<<<<<<<<<<<<<<<<<<<<<
    } else {
      mplusSyntax <- gsub("<var.clustr>", "", mplusSyntax)
    }
    mplusSyntax <- gsub("<var.weight>", selectionWeight, mplusSyntax)
    mplusSyntax <- gsub("<scale.name>", selectionScale, mplusSyntax)
    ...
    mplusSyntax <- gsub("<data.path1>", path1, mplusSyntax)
    mplusSyntax <- gsub("<data.path2>", path2, mplusSyntax)
    mplusSyntax <- gsub("<estimator.>", estmt, mplusSyntax)
    mplusSyntax <- gsub("<item.names>", items, mplusSyntax)
    mplusSyntax <- gsub("<items.used>", itemU, mplusSyntax)
    mplusSyntax <- gsub("<level.code>", lcode, mplusSyntax)
    mplusSyntax <- gsub("<mod.indics>", modin, mplusSyntax)
    mplusSyntax <- gsub("<phantom.ds>", phant, mplusSyntax)
    mplusSyntax <- gsub("<stmt.catgr>", catgr, mplusSyntax)
  ...
  if(selectionAnalysis=="Pooled CFA"){
    if(!is.na(as.numeric(selectionTargetLevelCode))){
      title <- paste0(nameStudy,": Pooled CFA for <scale.name> (<id.level..> ",as.numeric(selectionTargetLevelCode),")")
    } else {
      title <- paste0(nameStudy,": Pooled CFA for <scale.name>")
    }
    group <- ""
    if(paste(selectionGlobalDropCountry,collapse=" ")=="None" & paste(selectionScaleDropCountry,collapse=" ")=="None" & paste(selectionGlobalDropLevel,collapse=" ")=="None" & paste(selectionScaleDropLevel,collapse=" ")=="None" & paste(selectionGlobalDropPop,collapse=" ")=="None" & paste(selectionScaleDropPop,collapse=" ")=="None" & selectionAdjudicateVar=="None"){
      if(!is.na(as.numeric(selectionTargetLevelCode))){
        cases <- paste0("SUBPOPULATION IS (<id.level..> EQ ",as.numeric(selectionTargetLevelCode),");")
      } else {
        cases <- ""
      }
    } else {
      ...
      if(paste(selectionGlobalDropCountry,collapse=" ")!="None"){ 
        listGDC <- c()
        for(cnt in 1:length(selectionGlobalDropCountry)){
          cases <- paste0(cases," AND <id.country> NE ",selectionGlobalDropCountry[cnt])
      ...
      if(paste(selectionScaleDropCountry,collapse=" ")!="None"){
        listSDC <- c()
        for(cnt in 1:length(selectionScaleDropCountry)){
          cases <- paste0(cases," AND <id.country> NE ",selectionScaleDropCountry[cnt])
      ...
      if(!is.na(as.numeric(selectionTargetLevelCode))){
        if(paste(selectionGlobalDropPop,collapse=" ")!="None"){
          for(pop in 1:length(selectionGlobalDropPop)){
            ...
            if(droppedLevel==paste0(selectionLevelCodeVar,selectionTargetLevelCode) & !(droppedCntry %in% listGDC) & !(droppedCntry %in% listSDC)){
              cases <- paste0(cases," AND <id.country> NE ",droppedCntry)
            }
          }
        }
        if(paste(selectionScaleDropPop,collapse=" ")!="None"){
        ...
        if(paste(selectionGlobalDropLevel,collapse=" ")!="None"){
          for(lvl in 1:length(selectionGlobalDropLevel)){
            cases <- paste0(cases," AND <id.level..> NE ",selectionGlobalDropLevel[lvl])
          }
        }
        if(paste(selectionScaleDropLevel,collapse=" ")!="None"){
          for(lvl in 1:length(selectionScaleDropLevel)){
            cases <- paste0(cases," AND <id.level..> NE ",selectionScaleDropLevel[lvl])
          }
        }
        if(paste(selectionGlobalDropPop,collapse=" ")!="None"){
          for(pop in 1:length(selectionGlobalDropPop)){
            cases <- paste0(cases," AND <id.pop....> NE ",selectionGlobalDropPop[pop])
          }
        }
        if(paste(selectionScaleDropPop,collapse=" ")!="None"){
          for(pop in 1:length(selectionScaleDropPop)){
            cases <- paste0(cases," AND <id.pop....> NE ",selectionScaleDropPop[pop])
          }
        }
      }
      cases <- paste0(cases,");")
    ...
    if(selectionFS=="Yes"){
      auxil <- "AUXILIARY ARE <id.variabl><id.group..> <id.country> <id.level..> <id.pop....>;"
      sdata <- c("SAVEDATA:","<tabSpace>FILE IS FactorScores_<scale.name>_PooledCFA<suffix.opt>.dat;","<tabSpace>SAVE IS FSCORES;")
    } else {
      auxil <- ""
      sdata <- ""
    }
  ...
  if(selectionAnalysis=="Single Population CFA"){
    title <- paste0(nameStudy,": CFA for <scale.name> - <cntry.name> for <id.level..> <level.code>")
    group <- ""
    if(selectionAdjudicateVar!="None"){
      cases <- paste0("SUBPOPULATION IS (",selectionAdjudicateVar," EQ ",selectionAdjudicateCode)
      cases <- paste0(cases," AND <id.country> EQ <cntry.code> AND <id.level..> EQ <level.code>);")
    } else {
      cases <- "SUBPOPULATION IS (<id.country> EQ <cntry.code> AND <id.level..> EQ <level.code>);"
    }
    outpt <- "SAMPSTAT STANDARDIZED RESIDUAL TECH1 FSDETERMINACY SVALUES <mod.indics>"
    if(selectionFS=="Yes"){
      auxil <- "AUXILIARY ARE <id.variabl><id.group..> <id.country> <id.level..> <id.pop....>;"
      sdata <- c("SAVEDATA:","<tabSpace>FILE IS FactorScores_<scale.name>_<cntry.name>_<id.level..><level.code><suffix.opt>.dat;","<tabSpace>SAVE IS FSCORES;")
    } else {
      auxil <- ""
      sdata <- ""
    }
  ...
  if(selectionAnalysis=="Cross-country MGCFA with MI testing"){
    title <- paste0(nameStudy,": MG CFA for <scale.name> in the <id.level..> <level.code> level - Cross-Country, Single Level (Measurement Invariance testing)")
    auxil <- ""
    group <- "GROUPING IS <id.country> (<cntry.code>);"
    if(paste(selectionGlobalDropCountry,collapse=" ")=="None" & paste(selectionScaleDropCountry,collapse=" ")=="None" & paste(selectionGlobalDropPop,collapse=" ")=="None" & paste(selectionScaleDropPop,collapse=" ")=="None" & selectionAdjudicateVar=="None"){
      cases <- "USEOBSERVATION IS (<id.level..> EQ <level.code>);"
    } else {
      cases <- "USEOBSERVATION IS (<id.level..> EQ <level.code>"
      if(selectionAdjudicateVar!="None"){        
        cases <- paste0(cases," AND ",selectionAdjudicateVar," EQ ",selectionAdjudicateCode)
  ...
  if(selectionAnalysis=="Cross-level MGCFA with MI testing"){
    title <- paste0(nameStudy,": MG CFA for <scale.name> in <cntry.name> - Cross-Level, Single Country (Measurement Invariance testing)")
    auxil <- ""
    group <- "GROUPING IS <id.level..> (<level.code>);"
    if(paste(selectionGlobalDropLevel,collapse=" ")=="None" & paste(selectionScaleDropLevel,collapse=" ")=="None" & paste(selectionGlobalDropPop,collapse=" ")=="None" & paste(selectionScaleDropPop,collapse=" ")=="None" & selectionAdjudicateVar=="None"){
      cases <- "USEOBSERVATION IS (<id.country> EQ <cntry.code>);"
    } else {
      cases <- "USEOBSERVATION IS (<id.country> EQ <cntry.code>"
      if(selectionAdjudicateVar!="None"){        
        cases <- paste0(cases," AND ",selectionAdjudicateVar," EQ ",selectionAdjudicateCode)
    ...
    for(crow in 1:nrow(cntryMGCFA)){
      ...
      if(cntryMGCFA$RemoveCountriesSyntax[crow]!=""){
        ...
        for(cnt in 1:length(listCountry)){
          listCountry[cnt] <- paste0("<id.country> NE ", listCountry[cnt])
        }
    ...
    for(crow in 1:nrow(cntryMGCFA)){
      ...
      if(cntryMGCFA$RemoveLevelsSyntax[crow]!=""){
        ...
        for(lvl in 1:length(listLevel)){
          listLevel[lvl] <- paste0("<id.level..> NE ", listLevel[lvl])
        }
